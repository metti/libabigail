...
TEST_CASE("Symtab::SymtabWithWhitelist", "[symtab, whitelist]")
{
  GIVEN("a binary with one function and one variable exported")
  {
    ...
    GIVEN("we read the binary with all symbols on the whitelists")
    {
      ...
      whitelists.push_back(test_data_dir + "basic/ofov_all.whitelist");
    ...
    {
      std::vector<std::string> whitelists;
      whitelists.push_back(test_data_dir + "basic/ofov_irrelevant.whitelist");
    ...
    {
      std::vector<std::string> whitelists;
      whitelists.push_back(test_data_dir + "basic/ofov_function.whitelist");
      const corpus_sptr& corpus =
    ...
    {
      std::vector<std::string> whitelists;
      whitelists.push_back(test_data_dir + "basic/ofov_variable.whitelist");
      const corpus_sptr& corpus =
